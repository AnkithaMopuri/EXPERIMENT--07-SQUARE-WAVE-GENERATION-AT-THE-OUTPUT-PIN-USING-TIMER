...
<img width="1371" height="873" alt="out1" src="https://github.com/user-attachments/assets/50739417-44fa-4c45-b0be-12d6caf4fc37" />
<img width="1372" height="870" alt="out 2" src="https://github.com/user-attachments/assets/dbf7bec7-f60f-4833-b2e0-e35b6bcf83bf" />
<img width="1370" height="871" alt="out 3" src="https://github.com/user-attachments/assets/9a64d370-dc79-41ae-9526-325eca23660d" />

## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1216" height="847" alt="image" src="https://github.com/user-attachments/assets/4e534a93-6853-4f08-963d-df70be784f51" />
...
TOTAL TIME = 32 ms + 16 ms = 48 ms

FREQUENCY = 1/(TOTAL TIME) = 1/48 = 20 HZ
...
TOTAL TIME = 43 ms + 9.5 ms = 52.5 ms

FREQUENCY = 1/(TOTAL TIME) = 1/52.5 = 19 HZ
...
TOTAL TIME = 56 ms + 3 ms = 59 ms

FREQUENCY = 1/(TOTAL TIME) = 1/59 = 17 HZ
